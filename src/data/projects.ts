...
export const projects: CarouselItemProps[] = [
  ...
  },
  {
    ...
    It's important to note that accessing Yenn might involve a brief delay, as data fetching can take a few seconds due to the use of a free tier API server that requires some startup time.
